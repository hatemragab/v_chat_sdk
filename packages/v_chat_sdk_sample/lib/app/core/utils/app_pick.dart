...
abstract class AppPick {
  ...
  static Future<List<PlatformFile>?> getMedia() async {
    isPicking = true;
  ...
  static Future<PlatformFile?> getVideo() async {
    isPicking = true;
    final FilePickerResult? pickedFile = await FilePicker.platform.pickFiles(
      type: FileType.video,
    );
  ...
  static Future<List<PlatformFile>?> getFiles() async {
    isPicking = true;
  ...
  static Future<AssetEntity?> pickFromWeAssetCamera(
