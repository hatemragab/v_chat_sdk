...
class VArLocalizations extends VChatLocalizationLabels {
  ...
  @override
  String get errorWhileDownloadFile => "خطأ أثناء تنزيل الملف";
  ...
  @override
  String get joinedBy => "انضم";

  @override
  String get promotedToAdminBy => "تمت ترقيته إلى المشرف بواسطة";

  @override
  String get dismissedToMemberBy => "تم رفضه من قبل العضو";
  ...
  @override
  String get youDontHaveAccess => "ليس لديك وصول";

  @override
  String get replyToYourSelf => "الرد على نفسك";

  @override
  String get forwarded => "تم إعادة توجيهها";

  @override
  String get repliedToYourSelf => "رد على نفسك";

  @override
  String get messageHasBeenDeleted => "تم حذف الرسالة";

  @override
  String get chooseRooms => "اختر الغرف";

  @override
  String get mute => "صامت";

  @override
  String get unMute => "كتم الصوت";
  ...
  String get areYouSureToBlockThisUserCantSendMessageToYou =>
      "هل أنت متأكد من حظر هذا المستخدم لا يمكن إرسال رسالة إليك";
  ...
  String get leaveGroupAndDeleteYourMessageCopy =>
      "اترك المجموعة وحذف نسخة رسالتك؟";
